// src/components/Super Admin/DashboardPasswordLayout.js
import React, { useState } from "react";
import { getAuth, signOut } from "firebase/auth";
import { Outlet, Link, useLocation } from "react-router-dom";

// ✅ import images from src/images (case-sensitive; adjust names if yours differ)
...
export default function DashboardPasswordLayout() {
  ...
  const navLinks = [
    ...
    { to: "/PasswordSuper", img: IconKeyBlue, label: "Password Reset Request" }, // current
