...
export default function DashboardRouteLayout() {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (r) => (
        <div className="truncate" style={{ maxWidth: 260 }} title={r.Particular}>
          {r.Particular}
        </div>
      ),
    },
  ...
  const saveRoute = async () => {
    ...
    if (!form.Barangay.trim()) newErrors.Barangay = "Please fill out this field";
    if (!form.Particular.trim()) newErrors.Particular = "Please fill out this field";
    ...
    try {
      ...
      await setDoc(doc(db, "routes", String(nextId)), {
        ...
        SEDprice: Number(form.SEDprice || 0),
    ...
    try {
      await setDoc(
        doc(db, "routes", String(viewing.id)),
        {
          ...
          KM: Number(edit.KM),
          RegularPrice: Number(edit.RegularPrice || 0),
          SEDprice: Number(edit.SEDprice || 0),
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
            ...
            <div className="px-6 py-4 flex flex-wrap items-center gap-3">
              ...
              <div className="ml-auto flex items-center">
                <input
                  type="text"
                  placeholder="Search"
                  className="w-[380px] rounded-full border border-gray-200 px-4 py-2.5 text-sm text-gray-600 shadow-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-300 outline-none transition"
                  value={search}
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between px-6 py-4 border-b bg-white/70 backdrop-blur">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h2 className="text-lg font-semibold text-gray-800">Add New Route</h2>
                        <p className="text-xs text-gray-500">Provide details for the new route.</p>
                      </div>
                    </div>
                  ...
                  <div className="relative p-6 overflow-y-auto max-h-[calc(88vh-56px-64px)]">
                    <div className="grid grid-cols-2 gap-x-8 gap-y-5">
                      ...
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Particular</label>
                        <input
                          name="Particular"
                          className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-300 ${
                            errors.Particular ? "border-red-500" : "border-gray-200"
                          }`}
                          value={form.Particular}
                          onChange={onForm}
                        />
                        {errors.Particular && (
                          <p className="text-red-500 text-xs mt-1">{errors.Particular}</p>
                        )}
                      </div>
                      ...
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">S/E/D Price</label>
                        <input
                          name="SEDprice"
                          type="number"
                          step="0.01"
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-5 text-sm">
                      ...
                      <div>
                        ...
                        <input
                          className="w-full border rounded-md px-3 py-2 border-gray-200 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-300"
                          value={edit.Barangay}
                          onChange={(e) => setEdit({ ...edit, Barangay: e.target.value })}
                        />
                      </div>

                      <div>
                        <label className="block text-gray-600 mb-1">Particular</label>
                        <input
                          className="w-full border rounded-md px-3 py-2 border-gray-200 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-300"
                          value={edit.Particular}
                          onChange={(e) => setEdit({ ...edit, Particular: e.target.value })}
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border rounded-md px-3 py-2 border-gray-200 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-300"
                          value={edit.KM}
                          onChange={(e) => setEdit({ ...edit, KM: e.target.value })}
                        />
                      </div>

                      <div>
                        <label className="block text-gray-600 mb-1">Regular Price</label>
                        <input
                          type="number"
                          step="0.01"
                          min="0"
                          ...
                          onChange={(e) => setEdit({ ...edit, RegularPrice: e.target.value })}
                        />
                      </div>

                      <div>
                        <label className="block text-gray-600 mb-1">S/E/D Price</label>
                        <input
                          type="number"
                          step="0.01"
                          min="0"
                          className="w-full border rounded-md px-3 py-2 border-gray-200 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-300"
                          value={edit.SEDprice}
                          onChange={(e) => setEdit({ ...edit, SEDprice: e.target.value })}
                        />
                      </div>
      ...
      {isModalOpen && (
        <div
          className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-[70]"
          onClick={closeModal}
        >
          <div
